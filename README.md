...
<body>
    <h2>Pengembangan Aplikasi Sistem Informasi<br>Manajemen Perpustakaan<br>Berbasis Web<br>Metode Prototype</h2>
    <br>
    <hr>
    <br>
    ...
    <br>
       ...
       <ul>
        ...
        <p>Activity Diagram atau Diagram aktivitas adalah bentuk visual dari alur kerja yang berisi aktivitas dan tindakan, yang juga dapat berisi pilihan, atau pengulangan. 
            Dalam Unified Modeling Language(UML), diagram aktivitas dibuat untuk menjelaskan aktivitas komputer maupun alur aktivitas dalam organisasi. 
            Selain itu diagram aktivitas juga menggambarkan alur kontrol secara garis besar.</p>
        <p>Berikut beberapa tujuan dari activity diagram:
            <ol type="1">
                <li>Menjelaskan urutan aktivitas dalam suatu proses.</li>
                <li>Di dalam dunia bisnis biasanya digunakan untuk modeling (memperlihatkan urutan proses bisnis).</li>
                <li>Mudah dalam memahami proses yang ada dalam sistem secara keseluruhan.</li>
            ...
            <li><strong>Komponen Activity Diagram</strong></li>
            <img src="sources/Komponen AD.png" style="width: 600px; height: 580px;">   
        ...
        <li><strong>Syarat-Syarat Pembuatan Prototype</strong></li>
            ...
            <ul>
                ...
                <li>Memiliki sebuah potongan dari detail yang ada</li>
                <li>Memiliki sifat skalatis</li>
            </ul>
    </ol>
    <br>
    ...
    <br>
    <ol>
        <li><strong>Tahap Analysis Requirement</strong></li><br>
        <ol>
            <li>Analisis Kebutuhan Fungsional</li> 
        ...
        <ol>
            ...
            <p> Use Case Diagram merupakan daftar aksi atau tahapan yang mendefinisikan interaksi antara aktor dan sistem untuk mencapai suatu tujuan</p>
            <img src="sources/Use Case Diagram.png" style="width: 700px; height: 600px;">
            <p>Gambar 5. Use Case Diagram</p><br>
            <li>Activity Diagram</li>
                <p>Activity Diagram merupakan rancangan aliran aktivitas atau aliran kerja dalam sebuah sistem yang akan dijalankan. 
                    Activity Diagram juga digunakan untuk mendefinisikan atau mengelompokan aluran tampilan dari sistem tersebut.</p><br>
                <ol type="a">
                    <li>Admin</li><br>
                    <img src="sources/Activity Diagram-Admin.png">
                    <p>Gambar 6. Activity Diagram Admin - mengelola data pelamar</p><br>
                    <li>Operator</li><br>
                    <img src="sources/Activity Diagram-Operator.png">
                    <p>Gambar 7. Activity Diagram Operator</p>
                    <br><img src="sources/Activity Diagram-Operator (Pengembalian).png">
                    <p>Gambar 8. Activity Diagram Operator - Pengembalian</p><br>
                    <li>Anggota</li><br>
                    <img src="sources/Activity Diagram-Anggota.png">
                    <p>Gambar 9. Activity Diagram Anggota - Pendaftaran</p> 
                    <br><img src="sources/Activity Diagram-Anggota (Peminjaman).png">
                    <p>Gambar 10. Activity Diagram Anggota - Peminjaman</p><br>
                </ol>
            ...
            <p>Desain User Interface (UI) adalah proses yang digunakan desainer untuk membuat tampilan dalam perangkat lunak atau perangkat terkomputerisasi, dengan fokus pada tampilan atau gaya.</p>
                <ol type="a">
                    ...
                    <p>Gambar 11. Desain Interface pada halaman Login.</p>
                    <li>UI Halaman Admin</li>
                    <img src="sources/admin.png">
                    <p>Gambar 12. Desain Interface pada halaman Admin.</p>
                    <li>UI Halaman Operator</li>
                    <img src="sources/operator.png">
                    <p>Gambar 13. Desain Interface pada halaman Operator.</p>
